...
Функция ЭтоНеразделенныйОбъектМетаданных(ПолноеИмя) Экспорт
	...
	ОбщегоНазначенияКлиентСервер.ПроверитьПараметр("КонтрольВеденияУчета.ЭтоНеразделенныйОбъектМетаданных", "ПолноеИмя", ПолноеИмя, Тип("Строка"));
	
	Возврат КонтрольВеденияУчетаСлужебный.ЭтоНеразделенныйОбъектМетаданных(ПолноеИмя);
